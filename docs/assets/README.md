# CivicPulse Visual Evidence

These images are committed so the GitHub README shows the working project instead of placeholder diagrams.

- `dashboard-overview.png`: captured from the live React dashboard connected to the local FastAPI service. It shows the top fairness metrics, group decision-rate chart, group metrics table, and plain-English finding.
